...
3. FRONT is for storing elements, and REAR is for removing elements. (It's a choice, we can change it) 
...
4. Structure of a Queue:
    1. FRONT 
        1. It is a pointer to the front of the stack.
        2. It gets incremented by 1, when we add an element to Queue.
        3. It stops, when FRONT becomes equal to Capacity.
    2. REAR - It is the input direction of an element on the top of the stack.
