...
2. Suppose if we have algorithms $A$, $B$, $C$ and $D$
    ...
    Rate of growth vs. Input Size (n) plot, where $A$ taking linear growth $(n)$, $B$ taking quadratic growth $(n^2)$, $C$ taking contant growth $1$, and $D$ taking logarithmic growth $(\log_{2}{n})$
    ```
